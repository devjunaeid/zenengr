			...
			<div class="rounded-xl border border-slate-200/90 bg-white p-4 shadow-2xs space-y-3 transition-shadow hover:shadow-xs">
				...
				<div class="flex items-center justify-end gap-2 pt-1">
					<button
						...
						class="rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-indigo-600 shadow-2xs hover:bg-slate-50"
					...
					<button
						...
						class="rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 shadow-2xs hover:bg-slate-50"

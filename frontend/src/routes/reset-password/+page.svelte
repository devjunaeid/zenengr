...
<svelte:head><title>Reset password — ZenEngr</title></svelte:head>
	...
	<div class="w-full max-w-sm">
		<div class="rounded-lg border border-slate-200 bg-white p-8 shadow-sm">
			...
			{:else}
				...
				>
					<div>
						<label for="rp-new" class="block text-sm font-medium text-slate-700">New password</label
						>
						<input
							id="rp-new"
							type="password"
					...
					<div>
						<label for="rp-confirm" class="block text-sm font-medium text-slate-700"

...
1. Read this file and the `docs/` files listed below.
...
| ---------------- | ------- |
| `AGENTS.md` | Root agent instruction. Always read this first. It defines context files, skills, and workflow. |
...
- **Context loading:** Before any implementation task, run `/project-status`, read this file, then the specific `docs/features/`, `docs/stories/`, and `docs/todos/` files relevant to the task.

...
- **Current focus:** FEAT-014 tenant-wide formatting shipped (currency/timezone/date/time applied across both portals; date+time format dropdowns with demos; PDF uses currency code). All 151 todos complete.

...
- [ ] Prefs UI split into Email + In-app sections. (FR-17.6, AC-6)
- [ ] Channel-aware toggles per event type (new_comment, invoice_issued, payment_received, milestone_completed, refund_recorded, advance_applied, project_created). (FR-17.6, AC-6)
- [ ] Toggling in-app does not affect email and vice versa. (FR-17.6, AC-6)

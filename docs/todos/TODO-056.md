...
- [ ] Service model: id, tenant_id FK, name, description, default_price, is_active, timestamps.
- [ ] MilestoneStepTemplate model: id, service_id FK, name, sequence_order, expected_duration_days, description, timestamps.
- [ ] Alembic migration creates both tables.
- [ ] Different services can have different milestone structures (FR-6.3).
- [ ] CASCADE delete of service deletes its step templates.
